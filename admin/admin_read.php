                                        ...
                                        <table id=example class=display style=min-width: 845px>
                                            ...
                                            if (mysqli_num_rows($tampil) > 0) {
                                                ...
                                                while ($r = mysqli_fetch_array($tampil)){
                                                    ...
                                                    <td>$r[nama]</td>
                                                    <td>$r[email]</td>
                                                    <td><a href='admin_delete.php?id=$r[id_user]'>Hapus</a></td>
                                                    <td><a href='admin_edit.php?id=$r[id_user]'>Edit</a></td>
                                                    </tr>";
                                                    $no++;
                                                }
                                            echo "</table>";
